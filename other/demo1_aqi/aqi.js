...
const  askpaZPfnVAT = "axHpbvbuRfu7Az7h";//AESkey，可自定义
const  asi5sQRN8jOm = "biWaSi4JZiwtixCJ";//密钥偏移量IV，可自定义

const  ackK3pXbGDrf = "d3mVDRGvqCxxRUic";//AESkey，可自定义
const  aci9hrb8R4mr = "fXL97Duzags2Gzv9";//密钥偏移量IV，可自定义

const  dsk48uhICYCZ = "hvz3zBJKqyF5ZYVD";//DESkey，可自定义
const  dsiGGFXAV9v3 = "xAlafor0TxkwVTmC";//密钥偏移量IV，可自定义

const  dcksJ7HvURva = "o03g1fGESBLjJ2Kv";//DESkey，可自定义
const  dciCDKgdQJoh = "pVrbQG76KMBfekuv";//密钥偏移量IV，可自定义
...
// 代码
function pCgXRgEUNCORgbVu(mIpZpp76q, o7Viw1){
    var aBwJ = '61dced8aca662ae6fbdf75d16b5cd453';
    var cBsqy = 'WEB';
    var tP5OIW0 = new Date().getTime();
    ...
    var pOm0oFe = {
      ...
      clienttype: cBsqy,
      object: o7Viw1,
      secret: hex_md5(aBwJ + mIpZpp76q + tP5OIW0 + cBsqy + JSON.stringify(osLTFgBSId(o7Viw1)))
    };
    pOm0oFe = BASE64.encrypt(JSON.stringify(pOm0oFe));
    pOm0oFe = DES.encrypt(pOm0oFe, dcksJ7HvURva, dciCDKgdQJoh);
    return pOm0oFe;
};
...
function gVn7UEzXywDXWFjD(key, period) {
...
mmaEVf9y3 = "GETMONTHDATA"
oToS48QgcD = {"city":"上海"}
var kcF6 = pCgXRgEUNCORgbVu(mmaEVf9y3, oToS48QgcD);
console.log(kcF6)

pX9XrAe = 6;
const dZKQg = gVn7UEzXywDXWFjD(kcF6, pX9XrAe);
console.log(dZKQg)